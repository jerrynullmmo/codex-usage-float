...
swiftc -O -swift-version 5 -target arm64-apple-macosx14.0 Sources/UsageCore.swift Sources/ActiveConversation.swift Sources/FloatingUI.swift Sources/main.swift -o "$app/Contents/MacOS/CodexUsageFloat"
